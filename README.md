...
- [x] `Console`의 `readLine()`을 활용
- 예외
- [x] `,` 쉼표로 구분하고, 다른 문자나 공백이 있는 경우 예외 처리 
- [x] 1-45 범위를 벗어나면 예외 처리
- [x] 중복이 있을 경우 예외 처리
- [x] 당첨 번호가 6개가 아니라면 예외 처리
- [x] 보너스 번호가 1-45 범위의 정수가 아니라면 예외 처리
- [x] 보너스 번호가 당첨 번호에 포함된다면 예외 처리
#### 5. 당첨 내역 및 수익률 출력
- 조건
- [x] 당첨은 1등부터 5등까지 있고, 기준과 금액은 아래와 같다
```
...
5등: 3개 번호 일치 / 5,000원
```
- [x] 입력 받은 당첨 번호와 발행한 로또들을 비교해 당첨 판별
- [ ] 당첨 내역 종합 출력
...
- [x] indent(인덴트, 들여쓰기) depth 2 이하로
- [x] 함수(또는 메서드) 길이 15라인 이내로
- [x] 3항 연산자 사용 금지
